 ...
 */
class FeedCategory extends \Application\Entity\FeedCategory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\Entity\\FeedCategory' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\FeedCategory' . "\0" . 'feedCategoryValue', '' . "\0" . 'Application\\Entity\\FeedCategory' . "\0" . 'feed'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FeedCategory $proxy) {
